...
mod tests {
    ...
    fn checked_in_task_006_ledger_settled() {
        ...
        assert_eq!(task_status(&body, "011").as_deref(), Some("Completed"));
        assert_eq!(task_status(&body, "012").as_deref(), Some("Completed"));
        assert_eq!(task_status(&body, "013").as_deref(), Some("Completed"));
        assert_eq!(task_status(&body, "014").as_deref(), Some("Completed"));
        assert_eq!(task_status(&body, "015").as_deref(), Some("Completed"));
        ...
        assert_eq!(task_status(&body, "024").as_deref(), Some("Completed"));
        ...
        assert_eq!(task_status(&body, "029").as_deref(), Some("Completed"));
        ...
        assert_eq!(task_status(&body, "034").as_deref(), Some("Completed"));
        assert_eq!(task_status(&body, "035").as_deref(), Some("Completed"));
        assert_eq!(task_status(&body, "036").as_deref(), Some("Completed"));
        ...
        assert_eq!(epic_status(&body, "EPIC-008").as_deref(), Some("Completed"));
        assert_eq!(epic_status(&body, "EPIC-009").as_deref(), Some("Completed"));
        ...
        assert_eq!(phase_status(&body, 6).as_deref(), Some("Completed"));
        assert_eq!(phase_status(&body, 7).as_deref(), Some("Completed"));
    }
