...
See [docs/roadmap/README.md](docs/roadmap/README.md). Next work is TASK-011
(cancel / interrupt). ACP go is
...
`samchi-for-grok mcp` (six tools) are implemented. Host packaging lives in
