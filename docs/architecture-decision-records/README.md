...
| [0004-developer-instructions-meta-rules.md](0004-developer-instructions-meta-rules.md) | Accepted | Apply via `session/new` `_meta.rules`; restore with `session/load` on grok 1.0.30 |
