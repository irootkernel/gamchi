...
| [0003-developer-instructions-refuse.md](0003-developer-instructions-refuse.md) | Accepted | No spawn-owned instruction channel; refuse non-empty `developerInstructions` |
